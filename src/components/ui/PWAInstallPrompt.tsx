...
export default function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 max-w-sm mx-auto w-auto bg-[#121A3D] text-white p-4 rounded-3xl shadow-2xl border border-white/20 animate-in slide-in-from-bottom-5 font-sans block md:hidden">
