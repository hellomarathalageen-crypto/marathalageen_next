...
export const translations = {
  "en": {
    ...
    "preregister": {
      ...
      "genderLabel": "Gender *",
      "mobileLabel": "Mobile Number (For Login & Alerts) *",
      ...
      "birthTimeLabel": "Time of Birth (12-Hour AM/PM) *",
      "rashiLabel": "Rashi / Zodiac Sign *",
      "rashiSelect": "Select Rashi (Moon Sign)",
      "nakshatraLabel": "Nakshatra / Vedic Star *",
      "nakshatraSelect": "Select Nakshatra",
      "maritalStatusLabel": "Marital Status *",
      "heightLabel": "Height *",
      "heightSelect": "Select Height",
      "educationLabel": "Highest Qualification *",
      "educationPlaceholder": "e.g. B.E. Computer Science, MBA, B.Com",
      "professionLabel": "Profession / Occupation *",
      "professionPlaceholder": "e.g. Software Engineer, Civil Contractor, Govt Officer",
      "incomeLabel": "Annual Income *",
      "incomeSelect": "Select Income Range",
      "agePrefLabel": "Preferred Partner Age Range",
      "castePrefLabel": "Sub-Caste Preference",
      "castePrefAny": "Any Maratha Sub-Caste (All)",
      "castePrefSame": "Same Sub-Caste Preferred",
      "eduPrefLabel": "Partner Education Preference",
      "photoTitle": "Upload Candidate Photo (Optional)",
      "photoDesc": "You can upload a photo now or add it later after launch. Profiles with photos receive 10x more responses.",
      "photoBtn": "Select Photo from Device",
      "photoAttached": "Photo Attached",
      "photoOptimized": "Auto-Optimized",
      "removeBtn": "Remove",
      "photoOptionalNotice": "Photo Upload is Optional: You can submit now without a photo. A traditional avatar is assigned automatically, and you can upload photos later from your dashboard.",
      "privacyGuarantee": "100% Privacy & Security: Photos and phone numbers are protected. Details are unlocked only upon mutual family interest.",
    ...
    "whyPreRegister": {
      "badge": "Early Bird Privileges",
      "title": "Why Should I Pre-Register?",
      ...
      "benefits": [
        ...
        },
        {
          ...
          "subtitle": "Personalized assistance on WhatsApp & Phone"
        }
      ]
    },
    "whoCanRegister": {
      ...
      "cards": [
        ...
        },
        {
          ...
          "desc": "Brothers, sisters, and close relatives assisting in finding the ideal cultural alliance."
        }
      ]
    },
    "whyWeExist": {
      ...
      "title": "Why We Exist",
      "headline": "Parents do not need another generic website. They need peace of mind.",
      "subtitle": "Parents do not need another generic website. They need peace of mind.",
      "pillars": [
      ...
      "cards": [
        ...
        },
        {
          ...
          "desc": "Traditional alignment respecting Devak clans and Vedic 36 Gunas horoscope matching."
        }
      ]
    },
    "howItWorks": {
      "badge": "Simple 3-Step Process",
      "title": "How Maratha Lageen Works",
      "subtitle": "Simple, transparent, and dignified matchmaking for our community.",
    ...
    "contactSection": {
      ...
      "phoneCardTitle": "Helpline & Direct Call",
      "phoneCardSubtitle": "Mon - Sat: 9:00 AM - 8:00 PM",
      "phone1": "+91 98442 95369",
      "phone2": "+91 88619 62026",
      ...
      "namePlaceholder": "e.g. Anand Jadhav",
      "phoneLabel": "Mobile / WhatsApp Number *",
      "phonePlaceholder": "10-digit mobile number",
      "districtLabel": "District / City *",
      "districtPlaceholder": "e.g. Belagavi, Bengaluru",
      "messageLabel": "Your Inquiry / Question",
      "messagePlaceholder": "Ask about pre-registration, horoscope matching, or profile assistance...",
      "submitBtnText": "Send Request via WhatsApp ➔",
    ...
    "faqs": {
      ...
      "items": [
        ...
        },
        {
          ...
          "a": "Yes! Parents, brothers, sisters, or legal guardians can register and manage the matrimonial profile with complete family consent."
        },
        {
        ...
        },
        {
          ...
          "a": "Yes, once you log in to your dashboard, you can update your bio, upload additional gallery photos, update horoscope charts, and adjust partner preferences anytime."
        },
        {
          "q": "When will the platform officially launch with live matching?",
          "a": "We are concluding our initial Karnataka pre-registration drive and rolling out live matching and direct messaging shortly with thousands of verified profiles."
        }
      ]
    },
    "footer": {
  ...
  "kn": {
    ...
    "hero": {
      ...
      "titleLine1": "ಕರ್ನಾಟಕದ",
      "titleLine2": "ಮರಾಠಾ ವೈವಾಹಿಕ",
      "titleLine3": "ವೇದಿಕೆ",
      "subtitle": "ಕರ್ನಾಟಕದಾದ್ಯಂತ ಇರುವ ಮರಾಠಾ ಕುಟುಂಬಗಳಿಗಾಗಿಯೇ ವಿಶೇಷವಾಗಿ ರೂಪಿಸಲಾದ ವಿಶ್ವಾಸಾರ್ಹ ವೇದಿಕೆ — ಇಲ್ಲಿ ಪರಿಶೀಲಿಸಿದ ಪ್ರೊಫೈಲ್ಗಳು, ಆದ್ಯತೆ ನೀಡುವ ನೋಂದಣಿ ಮತ್ತು ನೈಜ ಸಂಪರ್ಕಗಳು ಲಭ್ಯವಿವೆ.",
    ...
    "whyPreRegister": {
      ...
      "benefits": [
        ...
        },
        {
          ...
          "subtitle": "ನೋಂದಣಿ ಮತ್ತು ಹೊಂದಾಣಿಕೆಗೆ ಮೀಸಲಾದ ಸಹಾಯವಾಣಿ"
        }
      ]
    },
    "whoCanRegister": {
      ...
      "cards": [
        ...
        },
        {
          ...
          "desc": "ತಮ್ಮ ಕುಟುಂಬದ ಸದಸ್ಯರಿಗೆ ಸೂಕ್ತ ಸಂಬಂಧವನ್ನು ನಿಗದಿಪಡಿಸಲು ಸಹಾಯ ಮಾಡುತ್ತಿರುವ ಸಂಬಂಧಿಕರು."
        }
      ]
    },
    "whyWeExist": {
      "badge": "ನಮ್ಮ ಮುಖ್ಯ ಉದ್ದೇಶ",
      "title": "ನಮ್ಮ ಅಸ್ತಿತ್ವದ ಕಾರಣ",
      "headline": "ಪಾಲಕರಿಗೆ ಬೇಕಾಗಿರುವುದು ಮತ್ತೊಂದು ಸಾಮಾನ್ಯ ವೆಬ್‌ಸೈಟ್ ಅಲ್ಲ, ಮನಸ್ಸಿನ ನೆಮ್ಮದಿ.",
      "subtitle": "ಪಾಲಕರಿಗೆ ಬೇಕಾಗಿರುವುದು ಮತ್ತೊಂದು ಸಾಮಾನ್ಯ ವೆಬ್‌ಸೈಟ್ ಅಲ್ಲ, ಮನಸ್ಸಿನ ನೆಮ್ಮದಿ.",
      "pillars": [
        { "title": "100% ಅಸಲಿ ಪ್ರೊಫೈಲ್‌ಗಳು", "desc": "ನಾವು ಕೇವಲ ಸಂಖ್ಯೆಗಿಂತ ಗುಣಮಟ್ಟ, ಕುಟುಂಬದ ಗೌರವ ಮತ್ತು ನೈಜತೆಗೆ ಆದ್ಯತೆ ನೀಡುತ್ತೇವೆ." },
        { "title": "ಸಂಪೂರ್ಣ ಗೌಪ್ಯತೆ ಭದ್ರತೆ", "desc": "ಫೋಟೋಗಳು ಮತ್ತು ಸಂಪರ್ಕ ಸಂಖ್ಯೆಗಳನ್ನು ರಕ್ಷಿಸಲಾಗುತ್ತದೆ. ಪರಸ್ಪರ ಸಮ್ಮತಿಯ ನಂತರವೇ ವಿವರಗಳು ತೆರೆಯುತ್ತವೆ." },
        { "title": "ಕರ್ನಾಟಕ ಮರಾಠ ಸಮಾಜ", "desc": "ಕರ್ನಾಟಕದ ಮರಾಠ ಕುಟುಂಬಗಳ ಸಾಂಸ್ಕೃತಿಕ ಪರಂಪರೆಗೆ ಮೀಸಲಾದ ಏಕೈಕ ವೇದಿಕೆ." },
        { "title": "ದೇವಕ & ಜಾತಕ ನಿಯಮಗಳು", "desc": "ದೇವಕ ಕುಲ, ಸಗೋತ್ರ ನಿಷೇಧ ಮತ್ತು ವೈದಿಕ 36 ಗುಣಗಳ ಜಾತಕ ಹೊಂದಾಣಿಕೆಗೆ ಸಂಪೂರ್ಣ ಗೌರವ." }
      ],
      "cards": [
        {
        ...
        },
        {
          ...
          "desc": "ದೇವಕ ಕುಲ, ಸಗೋತ್ರ ನಿಷೇಧ ಮತ್ತು ವೈದಿಕ 36 ಗುಣಗಳ ಜಾತಕ ಹೊಂದಾಣಿಕೆಗೆ ಸಂಪೂರ್ಣ ಗೌರವ."
        }
      ]
    },
    "howItWorks": {
      "badge": "ಸರಳ 3 ಹಂತಗಳ ಪ್ರಕ್ರಿಯೆ",
      "title": "ಮರಾಠ ಲಗ್ನ ಹೇಗೆ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ?",
      "subtitle": "ನಮ್ಮ ಸಮಾಜಕ್ಕಾಗಿ ಸರಳ, ಪಾರದರ್ಶಕ ಮತ್ತು ಗೌರವಾನ್ವಿತ ಮ್ಯಾಟ್ರಿಮೋನಿ ಸೇವೆ.",
      "step1Title": "1. ಆನ್‌ಲೈನ್‌ನಲ್ಲಿ ನೋಂದಾಯಿಸಿ",
      "step1Desc": "ಅಭ್ಯರ್ಥಿಯ ವಿವರಗಳು, ದೇವಕ, ಜಾತಕ ಮತ್ತು ಆದ್ಯತೆಗಳನ್ನು 2 ನಿಮಿಷಗಳಲ್ಲಿ ಭರ್ತಿ ಮಾಡಿ.",
      "step2Title": "2. ಪ್ರೊಫೈಲ್ ಪರಿಶೀಲನೆ",
      "step2Desc": "ನಮ್ಮ ತಂಡವು ಬಯೋಡೇಟಾ ಮತ್ತು ಕುಟುಂಬದ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸುತ್ತದೆ.",
    ...
    "contactSection": {
      ...
      "phoneCardTitle": "ನೇರ ಸಹಾಯವಾಣಿ ಕರೆ",
      "phoneCardSubtitle": "ಸೋಮ - ಶನಿ: ಬೆಳಿಗ್ಗೆ 9:00 ರಿಂದ ರಾತ್ರಿ 8:00 ರವರೆಗೆ",
      "phone1": "+91 98442 95369",
      "phone2": "+91 88619 62026",
      ...
      "namePlaceholder": "ಉದಾ: ಆನಂದ ಜಾಧವ್",
      "phoneLabel": "ಮೊಬೈಲ್ / ವಾಟ್ಸಾಪ್ ಸಂಖ್ಯೆ *",
      "phonePlaceholder": "10-ಅಂಕಿಯ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ",
      "districtLabel": "ಜಿಲ್ಲೆ / ಊರು *",
      "districtPlaceholder": "ಉದಾ: ಬೆಳಗಾವಿ, ಬೆಂಗಳೂರು",
      "messageLabel": "ನಿಮ್ಮ ಪ್ರಶ್ನೆ ಅಥವಾ ಸಂದೇಶ",
      "messagePlaceholder": "ನೋಂದಣಿ, ಜಾತಕ ಮಿಲನ ಅಥವಾ ಪ್ರೊಫೈಲ್ ಬಗ್ಗೆ ವಿಚಾರಿಸಿ...",
      "submitBtnText": "ವಾಟ್ಸಾಪ್ ಮೂಲಕ ವಿನಂತಿ ಕಳುಹಿಸಿ ➔",
      "privacyNotice": "🔒 ನಿಮ್ಮ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ ಮತ್ತು ವಿವರಗಳು 100% ಸುರಕ್ಷಿತವಾಗಿರುತ್ತವೆ."
    },
    "whatsappCta": {
      "title": "ಪ್ರಶ್ನೆಗಳಿವೆಯೇ? ವಾಟ್ಸಾಪ್‌ನಲ್ಲಿ ಸಂಪರ್ಕಿಸಿ",
      "subtitle": "ನೋಂದಣಿ, ಜಾತಕ ವಿವರಗಳು ಮತ್ತು ಪ್ರೊಫೈಲ್ ಸಹಾಯಕ್ಕಾಗಿ ನಮ್ಮ ಕುಟುಂಬ ಬೆಂಬಲ ತಂಡವು ಸದಾ ಲಭ್ಯವಿದೆ.",
      "btnText": "ವಾಟ್ಸಾಪ್‌ನಲ್ಲಿ ಸಹಾಯ ಪಡೆಯಿರಿ"
    },
    "faqs": {
      "badge": "ಸಾಮಾನ್ಯ ಪ್ರಶ್ನೋತ್ತರಗಳು",
      "title": "ಸಮುದಾಯದ ಪ್ರಮುಖ ಪ್ರಶ್ನೆಗಳಿಗೆ ಉತ್ತರಗಳು",
      "items": [
        {
        ...
        },
        {
          ...
          "a": "ಖಂಡಿತವಾಗಿ! ತಂದೆ, ತಾಯಿ, ಸಹೋದರ, ಸಹೋದರಿ ಅಥವಾ ಕುಟುಂಬದ ಪೋಷಕರು ಸಂಪೂರ್ಣ ಕುಟುಂಬ ಸಮ್ಮತಿಯೊಂದಿಗೆ ಪ್ರೊಫೈಲ್ ನೋಂದಾಯಿಸಬಹುದು."
        },
        {
          "q": "ಅಭ್ಯರ್ಥಿಯ ಫೋಟೋ ಮತ್ತು ಮೊಬೈಲ್ ಸಂಖ್ಯೆಯ ಗೌಪ್ಯತೆ ಹೇಗೆ ರಕ್ಷಿಸಲ್ಪಡುತ್ತದೆ?",
          "a": "ನಿಮ್ಮ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಯನ್ನು ಸುರಕ್ಷಿತವಾಗಿ ಮರೆಮಾಡಲಾಗುತ್ತದೆ. ಫೋಟೋಗಳನ್ನು ಐಚ್ಛಿಕವಾಗಿಡಬಹುದು ಮತ್ತು ಎರಡೂ ಕುಟುಂಬಗಳ ಪರಸ್ಪರ ಆಸಕ್ತಿಯ ನಂತರವೇ ವಿವರಗಳು ತೆರೆದುಕೊಳ್ಳುತ್ತವೆ."
        },
        {
          "q": "ಗೋತ್ರ ಮತ್ತು ದೇವಕ ಹೊಂದಾಣಿಕೆ ಹೇಗೆ ಪರಿಶೀಲಿಸಲಾಗುತ್ತದೆ?",
        ...
        },
        {
          ...
          "a": "ಹೌದು, ನಿಮ್ಮ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್‌ಗೆ ಲಾಗಿನ್ ಆದ ನಂತರ ಯಾವುದೇ ಸಮಯದಲ್ಲಿ ನಿಮ್ಮ ಫೋಟೋ, ಶಿಕ್ಷಣ, ಜಾತಕ ಮತ್ತು ಸಂಗಾತಿಯ ಆದ್ಯತೆಗಳನ್ನು ಬದಲಾಯಿಸಬಹುದು."
        },
        {
          "q": "ವೇದಿಕೆಯು ಅಧಿಕೃತವಾಗಿ ಯಾವಾಗ ಲೈವ್ ಮ್ಯಾಚಿಂಗ್ ಪ್ರಾರಂಭಿಸುತ್ತದೆ?",
          "a": "ಕರ್ನಾಟಕದ ಪೂರ್ವ ನೋಂದಣಿ ಅಭಿಯಾನವು ಮುಕ್ತಾಯ ಹಂತದಲ್ಲಿದ್ದು, ಸಾವಿರಾರು ಪರಿಶೀಲಿಸಿದ ಪ್ರೊಫೈಲ್‌ಗಳೊಂದಿಗೆ ಶೀಘ್ರದಲ್ಲೇ ಲೈವ್ ಮ್ಯಾಚಿಂಗ್ ಪ್ರಾರಂಭವಾಗಲಿದೆ."
        }
      ]
    },
    "footer": {
