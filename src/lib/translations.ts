...
export const translations = {
  "en": {
    ...
    "aboutSection": {
      "badge": "About Maratha Lageen",
      "title": "Preserving Maratha Heritage in Karnataka",
      "desc1": "Maratha Lageen was founded with a sacred mission: to bring together Maratha families across Karnataka (Belagavi, Bengaluru, Dharwad, Hubballi, Uttara Kannada, Bagalkote, Vijayapura, Bidar, and Kalaburagi) on one trusted community platform.",
      "desc2": "We honor ancient traditions of 96 Kuli Maratha, respecting Gotra, Devak, and Kuldaivat while providing cutting-edge security and privacy for the new generation.",
      "founderTitle": "Founder & Community Organizer",
      "founderDesc": "Dedicated to uniting Kshatriya Maratha Samaj across South India with dignity and cultural integrity."
    },
    "whatsappCta": {
  ...
  "kn": {
    ...
    "aboutSection": {
      ...
      "desc2": "ನಾವು 96 ಕುಳಿ ಮರಾಠ ಪರಂಪರೆ, ಗೋತ್ರ, ದೇವಕ ಮತ್ತು ಕುಲದೈವತಗಳನ್ನು ಗೌರವಿಸುತ್ತಾ, ಹೊಸ ಪೀಳಿಗೆಗೆ ಅತ್ಯಾಧುನಿಕ ತಂತ್ರಜ್ಞಾನ ಮತ್ತು ಭದ್ರತೆಯನ್ನು ನೀಡುತ್ತಿದ್ದೇವೆ.",
      "founderTitle": "ಸಂಸ್ಥಾಪಕರು & ಸಮುದಾಯ ಸಂಘಟಕರು",
      "founderDesc": "ದಕ್ಷಿಣ ಭಾರತದ ಕ್ಷತ್ರಿಯ ಮರಾಠ ಸಮಾಜವನ್ನು ಗೌರವ ಮತ್ತು ಸಾಂಸ್ಕೃತಿಕ ನಿಷ್ಠೆಯೊಂದಿಗೆ ಒಂದುಗೂಡಿಸಲು ಬದ್ಧರಾಗಿದ್ದಾರೆ."
    },
    "whatsappCta": {
