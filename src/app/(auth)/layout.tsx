...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-[#173F73] relative overflow-hidden p-10 text-white">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#173F73]/90 via-[#173F73]/70 to-[#173F73]" />
        </div>
        ...
        <div className="relative z-10 flex items-center gap-2">
          ...
          <div>
            <p className="text-xl font-bold font-serif leading-none">Maratha</p>
            <p className="text-xs text-[#F34883] font-semibold tracking-wide">Matrimony</p>
          </div>
        </div>
        ...
        <div className="relative z-10 mb-10">
          <h1 className="text-4xl font-bold font-serif mb-4 leading-tight">
            ...
            <span className="text-[#F34883]">Maratha Partner.</span>
          </h1>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <div className="p-6 md:p-8 flex justify-between items-center lg:justify-end">
          ...
          <Link href="/home" className="lg:hidden flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-bold font-serif text-[#173F73] leading-none">Maratha</p>
              <p className="text-[10px] text-[#F34883] font-semibold tracking-wide">Matrimony</p>
            </div>
          </Link>
          
          <Link href="/home" className="text-sm font-semibold text-gray-500 hover:text-[#173F73] flex items-center gap-1.5 transition-colors">
